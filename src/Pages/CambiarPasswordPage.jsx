...
export const CambiarPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await authService.cambiarPassword(formData.passwordActual, formData.passwordNueva)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--persian-plum-50)] to-[var(--persian-plum-100)] px-4 py-12">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-2xl">
        {/* Header */}
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[var(--persian-plum-900)]">
            Cambiar Contraseña
          </h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="appearance-none relative block w-full px-4 py-3 pr-12 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--persian-plum-500)] focus:border-transparent transition-all"
          ...
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-3 px-4 bg-[var(--persian-plum-600)] hover:bg-[var(--persian-plum-700)] text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
