      ...
      if (error.response) {
        ...
        switch (status) {
          case 401:
            ...
            } else if (errorMsg.toLowerCase().includes('usuario') || errorMsg.toLowerCase().includes('email')) {
              setErrors({ ...errors, email: 'Email no registrado' })
          ...
          case 403:
            toast.error('Tu cuenta ha sido bloqueada. Contacta con soporte.')
            break
