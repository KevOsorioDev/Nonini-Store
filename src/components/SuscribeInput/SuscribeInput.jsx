...
export const SuscribeInput = () => {
  ...
  <input type="email" name="email" className="input" placeholder="ejemplo@gmail.com" />
...
const StyledWrapper = styled.div`
  ...
  .input:-webkit-autofill {
    ...
    -webkit-text-fill-color: var(--persian-plum-50);
  }
  .Subscribe-btn {
    height: 100%;
    width: 95px;
    ...
    color: rgb(0, 0, 0);
    cursor: pointer;
    background-color: var(--persian-plum-300);
    color: var(--persian-plum-950);
    font-weight: 600;
    overflow: hidden;
    display: flex;
    align-items: center;
  ...
  .Subscribe-btn:hover {
  color: var(--persian-plum-300);
  }
  .Subscribe-btn:hover .arrow {
    margin-right: 0;
    animation: jello-vertical 0.9s both;
    transform-origin: right;
    fill: var(--persian-plum-50)
  }
